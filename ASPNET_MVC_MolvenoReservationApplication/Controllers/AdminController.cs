...
namespace ASPNET_MVC_MolvenoReservationApplication.Controllers
{
    public class AdminController : Controller
    {
        ...
        // GET: Reservations
        public async Task<IActionResult> OverviewReservations()
        {
        ...
        [HttpPost]
        public IActionResult OverviewReservations(IndexViewModel IndexViewModelInput)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult ReservationSettings(ReservationViewModel ResView)
        {
            return View();
        }
    }
